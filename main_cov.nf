...
process samtools {
    ...
    samtools view -c ${sam_file.simpleName}.sorted.bam >> ${sam_file.simpleName}_cov.txt
    samtools view -c -F 260 ${sam_file.simpleName}.sorted.bam >> ${sam_file.simpleName}_cov.txt
    samtools depth -b +'/AmericasN.bed', OutputFolder+'/cacheoutput.bam
